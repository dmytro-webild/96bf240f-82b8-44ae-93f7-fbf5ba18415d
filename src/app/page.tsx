...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      testimonials={[
        ...
        {
          name: "Елена Димитрова",          handle: "@ElenaD",          testimonial: "Б.Б. Маркет е моят магазин за всичко – от основни хранителни продукти до вкусна готова храна.",          rating: 5,
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "1",          name: "Анна Стоянова",          handle: "@AnnaS",          testimonial: "Б.Б. Маркет е моят избор за пазаруване. Винаги намирам качествени продукти и всичко е много добре подредено. Пиците са невероятни!",          imageSrc: "http://img.b2bpic.net/free-photo/woman-bed-showing-ok-gesture_23-2147767529.jpg?_wi=2",          imageAlt: "Anna Stoyanova"},
        {
          id: "2",          name: "Петър Иванов",          handle: "@PetarI",          testimonial: "Работя наблизо и често си взимам кафе и сандвич от Б.Б. Маркет. Обслужването е бързо, а храната винаги прясна и вкусна. Горещо препоръчвам!",          imageSrc: "http://img.b2bpic.net/free-photo/portrait-cheerful-teenage-girl-sitting-cafe_1262-3048.jpg?_wi=2",          imageAlt: "Petar Ivanov"},
        {
  ...
  <div id="contact" data-section="contact">
      ...
      inputs={[
        ...
        {
          name: "phone",          type: "tel",          placeholder: "Вашият телефон"},
      ]}
      textarea={{
